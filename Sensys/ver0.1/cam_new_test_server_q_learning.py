...
class myThread(threading.Thread):
    def __init__(self, threadID, socketIO, name, frame, fps, cut_point, data_frame):
...
def main(_):
    ...
    while True:
        ...
        if data == "time_start":
            ...
            #--------------------多线程发送------------
            # Create a thread
            thread_socketIO = myThread(1,socketIO, "Frame-"+str(counter), output_image, Fps, cut_point, q_table.values)
